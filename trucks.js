var foodTrucks = [
    {
        ...
        payment: ["Cash", "Cards"],
        description: "We love pies - sweet and savory. We serve them up to the hungry people " +
           "in Seattle in our fabulous food truck",
    ...
    },
    {
        ...
        payment: ["Cash", "Cards"],
        description: "Ice creams and sorbets that are intensely flavored and as locally " +
           "sourced and seasonal as possible without sacrificing taste or texture. All from " +
           "a fetching cart.",
    ...
    },
    {
        ...
        payment: ["Cash", "Cards"],
        description: "Offsite catering from Barking Frog is hitting the road in style to " +
           "satisfy your Grand Marnier Prawn craving by bringing (your favorite) gourmet eats " +
           "to the streets!",
    ...
    },
    {
        ...
        schedule: ["Monday"],
        payment: ["Cash", "Cards"],
        description: "Barriga Llena was the first vendor to introduce traditional Mexican " +
           "tortas to Seattle, just the way you have them in Mexico City",
    ...
    },
    {
        ...
        payment: ["Cash", "Cards"],
        description: "Alaskan Reindeer Sausages & other gourmet and exotic Sausages and " +
           "hotdogs",
    ...
    },
    {
        ...
        payment: ["Cash", "Cards"],
        description: "Bring people together using their sense of Filipino cuisine in a \
           unique and flavorful way",
    ...
    },
    {
        ...
        payment: ["Cash", "Cards"],
        description: "Hand made ice cream, ice cream sandwiches, and floats in the summer, " +
           "hearty soups and stews in the cold, rainy months",
    ...
    },
    {
        ...
        schedule: ["Tuesday"],
        payment: ["Cash", "Cards"],
        description: "Chinese crepes, also known at jiangbing are a delicious traditional " +
           "Chinese street snack",
    ...
    },
    {
        ...
        schedule: ["Monday", "Tuesday", "Wednesday", "Thursday", "Friday"],
        payment: ["Cards"],
        description: "Sweet and Savory smothered biscuits made with local and seasonal " +
           "ingredients",
    ...
    },
    {
        ...
        type: ["Dessert"],
        payment: ["Cash", "Cards"],
        description: "Cupcakes, Gelato and Pastry Truck serving curbside throughout King, " +
           "Snohomish, Skagit Counties in Wa.",
    ...
    },
    {
        ...
        payment: ["Cash", "Cards"],
        description: "Asian Fusion, like the truck's     name Chopstix. Our specialty is a " +
           " little twist of Asian cuisine with western cuisine",
    ...
    },
    {
        ...
        payment: ["Cash", "Cards"],
        description: "A bike-driven mobile coffee stand bringing manually-brewed specialty " +
           "coffee to Seattle streets, previously Handlebar Coffee",
    ...
    },
    {
        ...
        schedule: ["Tuesday"],
        payment: ["Cash", "Cards"],
        description: "Locally sourced, in-season, top-shelf ingredients in exquisitely crafted " +
           "crepes",
    ...
    },
    {
        ...
        payment: ["Cash", "Cards"],
        description: "Savory and sweet crepes; breakfast, lunch and dinner; hot coffee and " +
           "espresso drinks",
    ...
    },
    {
        ...
        schedule: ["Sunday"],
        payment: ["Cash", "Cards"],
        description: "Fruit Chatter Box provides fresh, seasonal fresh fruit in cups or on a " +
           "stick at local festivals and street fairs.",
...
// getFoodTypes() - return unique list of all associated food types
...
function getTrucks() {
    return foodTrucks.slice(0);
}

function getTruck(name) {
    name = name.toLowerCase();
    var truck = foodTrucks.filter(function(truck) {
        return truck.name.toLowerCase() === name;
    });
...
function getFoodTypes() {
    ...
    var foods = new Set();
    foodTrucks.forEach(function(entry) {
        entry.type.forEach(function(ent) {
            foods.add(ent);
        });
    });
...
function filterTrucksByDay(day) {
    var trucks = foodTrucks.filter(function(element) {
        return element.schedule && (element.schedule.indexOf(day) >= 0);
    });
...
function filterByFoodType(food) {
    ...
    foodTrucks.forEach(function(entry) {
        entry.type.forEach(function(ent) {
            if (ent.toLowerCase() === food) {
                trucks.push(entry.name);
            }
        });
    });
...
function removeTruck(name) {
    name = name.toLowerCase();
    var ndx = foodTrucks.findIndex(function(truck) {
        return truck.name.toLowerCase() === name;
    });

    if (ndx > -1) {
        foodTrucks.splice(ndx, 1);
    }
