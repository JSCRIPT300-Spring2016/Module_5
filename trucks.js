...
var foodTrucks = [
  ...
  },
  {
    ...
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday',
               'Saturday', 'Sunday'],
    payment: ['Cash', 'Cards'],
    description: 'Authentic Mexican cuisine made w/ natural, \
      organic ingredients',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Bring people together using their sense of \
      Filipino cuisine in a unique and flavorful way',
  ...
  },
  {
    ...
    type: ['Sandwiches'],
    payment: ['Cash', 'Cards'],
    description: 'Steak sandwiches, burgers, pulled pork, \
      beignets, quesadillas, nachos',
  ...
  },
  {
    ...
    description: 'All of Big House BBQ\'s meats are slow smoked using \
      seasoned apple wood, and alter from the Great Northwest because \
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Hand made ice cream, ice cream sandwiches, and floats \
      in the summer, hearty soups and stews in the cold, rainy months',
  ...
  },
  {
    ...
    Facebook: 'https://www.facebook.com/pages/Bikelava-Artisan-\
      Peddled-Baklava/246842835435535'
  },
  {
    name: 'Bing of Fire',
    type: ['Chinese Crepes'],
  ...
  },
  {
    ...
    Facebook: 'https://www.facebook.com/pages/Bite-Me-Cupcakes-\
      Eatery/210398125665053'
  },
  {
    name: 'Bomba Fusion',
  ...
  },
  {
    name: 'Cake Mobile',
    type: ['Sweets'],
    description: 'Events and festivals, and parked at their building \
      near the Tacoma Dome before and after concerts and Dome events',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Asian Fusion, like the truck\'s name Chopstix. \
      Our specialty is a little twist of Asian cuisine with western cuisine',
  ...
  },
  {
    ...
    type: ['Mexican'],
    payment: ['Cash', 'Cards'],
    description: 'Modern Mexican - hand made tortillas and \
      gorditas, all gluten-free',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Savory and sweet crepes; breakfast, lunch and \
      dinner; hot coffee and espresso drinks',
    website: 'http://cremacreperie.com',
    Facebook: 'https://www.facebook.com/pages/Crema-Creperie-Espresso-\
      Bar/303099846462139'
  },
  {
  ...
  },
  {
    ...
    Facebook: 'https://www.facebook.com/pages/Delicatessen-\
      Montanti/823352311016462'
  },
  {
  ...
  },
  {
    ...
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Saturday',
               'Sunday'],
    payment: ['Cash'],
    description: 'Bringing you the finest and most authentic \
      of Mexican cuisine',
  ...
  },
  {
    ...
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday'],
    payment: ['Cash', 'Cards'],
    description: 'Specializing in Gourmet Tortas, Tacos, Tamales \
      (on green banana leaf) and Quesadillas',
  ...
  },
  {
    ...
    schedule: ['Monday', 'Tuesday', 'Wednesday', 'Thursday', 'Friday',
               'Saturday', 'Sunday'],
    payment: ['Cash'],
    description: 'Regular taco truck in the Fremont \
      neighborhood - open 7 days a week and late night',
  ...
  },
  {
    ...
    payment: ['Cash', 'Cards'],
    description: 'Gourmet hot dogs, weiners, sausages, hot links \
      and more, contact at 425.761.9447 or franksfranks3@gmail.com',
  ...
  },
  {
    ...
    schedule: ['Sunday'],
    payment: ['Cash', 'Cards'],
    description: 'Fruit Chatter Box provides fresh, seasonal fresh \
      fruit in cups or on a stick at local festivals and street fairs.',
